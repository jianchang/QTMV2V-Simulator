...
**
** Created: Sat Jun 9 20:07:05 2012
...
QMetaObject* QSimCreateDialog::staticMetaObject()
{
    ...
    static const QUMethod slot_29 = {"slotIncidentsListHighlighted", 1, param_slot_29 };
    static const QUMethod slot_30 = {"slotIncidentsListSelChanged", 0, 0 };
    static const QUParameter param_slot_31[] = {
	{ "id", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_31 = {"slotIncidentsAdd", 1, param_slot_31 };
    static const QUMethod slot_32 = {"slotIncidentsRemove", 0, 0 };
    static const QUMethod slot_33 = {"slotIncidentsDuplicate", 0, 0 };
    static const QUParameter param_slot_34[] = {
	{ "strName", &static_QUType_QString, 0, QUParameter::In }
    };
    static const QUMethod slot_34 = {"slotIncidentsNameChanged", 1, param_slot_34 };
    static const QUParameter param_slot_35[] = {
	{ "row", &static_QUType_int, 0, QUParameter::In },
	{ "col", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_35 = {"slotIncidentsPropertiesValueChanged", 2, param_slot_35 };
    static const QUParameter param_slot_36[] = {
	{ "row", &static_QUType_int, 0, QUParameter::In },
	{ "col", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_36 = {"slotIncidentsPropertiesCurrentChanged", 2, param_slot_36 };
    static const QUMethod slot_37 = {"slotIncidentsAutoGen", 0, 0 };
    static const QUMethod slot_38 = {"slotIncidentsRemoveAll", 0, 0 };
    static const QUMethod slot_39 = {"slotOK", 0, 0 };
	...
	{ "slotIncidentsListHighlighted(int)", &slot_29, QMetaData::Protected },
	{ "slotIncidentsListSelChanged()", &slot_30, QMetaData::Protected },
	{ "slotIncidentsAdd(int)", &slot_31, QMetaData::Protected },
	{ "slotIncidentsRemove()", &slot_32, QMetaData::Protected },
	{ "slotIncidentsDuplicate()", &slot_33, QMetaData::Protected },
	{ "slotIncidentsNameChanged(const QString&)", &slot_34, QMetaData::Protected },
	{ "slotIncidentsPropertiesValueChanged(int,int)", &slot_35, QMetaData::Protected },
	{ "slotIncidentsPropertiesCurrentChanged(int,int)", &slot_36, QMetaData::Protected },
	{ "slotIncidentsAutoGen()", &slot_37, QMetaData::Protected },
	{ "slotIncidentsRemoveAll()", &slot_38, QMetaData::Protected },
	{ "slotOK()", &slot_39, QMetaData::Protected }
    };
...
bool QSimCreateDialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 29: slotIncidentsListHighlighted((int)static_QUType_int.get(_o+1)); break;
    case 30: slotIncidentsListSelChanged(); break;
    case 31: slotIncidentsAdd((int)static_QUType_int.get(_o+1)); break;
    case 32: slotIncidentsRemove(); break;
    case 33: slotIncidentsDuplicate(); break;
    case 34: slotIncidentsNameChanged((const QString&)static_QUType_QString.get(_o+1)); break;
    case 35: slotIncidentsPropertiesValueChanged((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    case 36: slotIncidentsPropertiesCurrentChanged((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    case 37: slotIncidentsAutoGen(); break;
    case 38: slotIncidentsRemoveAll(); break;
    case 39: slotOK(); break;
    default:
