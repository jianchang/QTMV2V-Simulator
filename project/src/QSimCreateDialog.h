...
public:
	...
	std::vector<std::pair<QString, QString> > m_vecIncidents; // added by Cong
...
protected slots:
	...
	//-------------------------------------------------------------------------
	virtual void slotIncidentsListHighlighted(int index);
	virtual void slotIncidentsListSelChanged();
	virtual void slotIncidentsAdd(int id);
	virtual void slotIncidentsRemove();
	virtual void slotIncidentsDuplicate();
	virtual void slotIncidentsNameChanged(const QString & strName);
	virtual void slotIncidentsPropertiesValueChanged(int row, int col);
	virtual void slotIncidentsPropertiesCurrentChanged(int row, int col);
	virtual void slotIncidentsAutoGen();
	virtual void slotIncidentsRemoveAll();
	//----------------------------added by Cong--------------------------------
...
protected:
	...
	//---------------------------------------------------------------------------------------
	QPushButton * m_buttonIncidentAdd, * m_buttonIncidentRemove, * m_buttonIncidentDuplicate, * m_buttonIncidentAutoGen, * m_buttonIncidentRemoveAll;
	QListBox * m_listIncidents;
	QLabel * m_lblIncidentName;
	QLineEdit * m_txtIncidentName;
	QTable * m_tableIncidentProperties;
	QTextEdit * m_txtIncidentPropertiesHelp;
	QPopupMenu * m_pIncidentsAddMenu;
	//--------------------------------------added by Cong-------------------------------------
