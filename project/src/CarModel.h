...
public:
	...
	virtual void sendIncidentMessage(IncidentModel * pIncident); // added by Cong
...
protected:
	...
	// keep track of the incidents witnessed by the car
	std::map<Coords, IncidentModel *> m_vitIncidents; // added by Cong
};
