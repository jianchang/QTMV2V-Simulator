...
: m_pModelTreeNodes(NULL), m_nModelTreeNodes(0), m_modelsMutex(true)
{
	...
	//--- added by Cong
	RegisterModel(IncidentModelCreator, INCIDENTMODEL_NAME);
	RegisterModel(IncidentListVisualCreator, INCIDENTLISTVISUAL_NAME);
	RegisterModel(VehicleModelCreator, VEHICLEMODEL_NAME);
	RegisterModel(AuthorityRoleModelCreator, AUTHORITYROLEMODEL_NAME);
	RegisterModel(AttackerRoleModelCreator, ATTACKERROLEMODEL_NAME);
	RegisterModel(DefaultRoleModelCreator, DEFAULTROLEMODEL_NAME);
	//---
